...
### Breaking changes
This integration no longer requires or includes the `deadline-cloud-for-keyshot ` adaptor package. Instead, the adaptor is packaged with each job submission. The old adaptor will continue to be available in Deadline's service managed fleets for a short period of time to ensure installs of the old submitter continue to work, but users should upgrade to the new submitter as soon as they are able to.
