# KeyShot submitter for AWS Deadline Cloud using embedded session and task scripts
...
# These placeholders will be replaced by build.py with the actual script contents
        ...
        "steps": [
            {
                ...
                "stepEnvironments": [
                    {
                        "name": "KeyShot",
                        "description": "Runs KeyShot session script in the background.",
                        "script": {
                            "embeddedFiles": [
                                {
                                    "name": "sessionScript",
